...
#error  "CLK_CFG_STR_CONV_EN illegally #define'd in 'common_cfg.h'. MUST be DEF_ENABLED."
#endif

#if  (CLK_CFG_UNIX_EN != DEF_ENABLED)
#error  "CLK_CFG_UNIX_EN illegally #define'd in 'common_cfg.h'. MUST be DEF_ENABLED."
#endif
#endif
